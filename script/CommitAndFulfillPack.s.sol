...
contract CommitAndFulfillPack is PacksScriptBase {
    address packsContractAddress = vm.envAddress("PACKS_CONTRACT_ADDRESS");
    address payable public PACKS = payable(packsContractAddress);
    ...
    function run() external {
        ...
        uint256 tokenId = 487;
        uint256 orderAmount = 0.0105 ether; // Adjusted to fall within Bucket 1 range (0.01 - 0.011 ether)
        ...
        // 7. Determine fulfillment option
        ...
        // Calculate payout amount based on fulfillment option
        uint256 payoutAmount = isNFTFulfillment ? 0 : orderAmount; // For payout, use the full order amount
